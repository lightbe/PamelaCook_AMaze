...
public class Waypoint : MonoBehaviour
{
    ...
    [Header("Speed Between Waypoints")]     public float speed = 0.05f;
    ...
    Vector3 currentCamera, currentGameObject;
    ...
    public void Click()
    {
        ...
        if (this.gameObject.name == "Waypoint (33)")
        {
        ...
        //if (this.gameObject.name == "Waypoint (33)")
        //{
        //    currentCamera = new Vector3(Camera.main.transform.parent.transform.position.x, cameraHeight + cameraHeightDoor, Camera.main.transform.parent.transform.position.z);
        //    currentGameObject = new Vector3(gameObject.transform.position.x, cameraHeight + cameraHeightDoor, gameObject.transform.position.z);
        //}
        //else
        //{
        //    currentCamera = new Vector3(Camera.main.transform.parent.transform.position.x, cameraHeight, Camera.main.transform.parent.transform.position.z);
        //    currentGameObject = new Vector3(gameObject.transform.position.x, cameraHeight, gameObject.transform.position.z);
        //}

        //float distance = Vector3.Distance(currentCamera, currentGameObject);

        //if (distance > speed)
        //{
        //    Camera.main.transform.parent.transform.position = Vector3.Lerp(currentCamera, currentGameObject, speed);
        //}
        //else
        //{
        //    Camera.main.transform.parent.transform.position = currentGameObject;
        //}
